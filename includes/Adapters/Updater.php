...
class Updater extends AbstractUpdater {
	...
	public function localize_strings(): array {
		...
		return array(
			...
			/* translators: %s: Plugin name. */ 'rollback_action_button' => sprintf( esc_html__( 'Rollback %s', 'storepress-base-plugin' ), $name ),
			...
			/* translators: %s: Time elapsed (e.g. "2 hours"). */ 'rollback_last_updated' => esc_html__( 'Last updated %s ago.', 'storepress-base-plugin' ),
			/* translators: %s: Plugin name. */ 'rollback_view_changelog' => sprintf( esc_html__( 'View Changelog for %s', 'storepress-base-plugin' ), $name ),
			/* translators: %s: Plugin name. */ 'rollback_page_title' => sprintf( esc_html__( 'Rollback Plugin %s', 'storepress-base-plugin' ), $name ),
			...
			/* translators: 1: Plugin name, 2: Version number. */ 'rollback_success' => esc_html__( 'Rollback success: %1$s rolled back to version %2$s.', 'storepress-base-plugin' ),
			...
			/* translators: %s: Plugin name. */ 'rollback_not_available' => esc_html__( 'Rollback is not available for plugin: %s', 'storepress-base-plugin' ),
